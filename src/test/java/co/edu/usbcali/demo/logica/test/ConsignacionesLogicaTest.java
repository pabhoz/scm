...
public class ConsignacionesLogicaTest {
	...
	public void aTest() throws Exception {
		...
		consignaciones.setConDescripcion("Consignación de prueba");
	...
	public void bTest() throws Exception {
		...
		assertNotNull("No existe la consignación", consignaciones);
	...
	public void cTest() throws Exception {
		Consignaciones consignaciones = consignacionesLogica.consultarPorId(new ConsignacionesId(consignacionID, cuentaNumero));
		assertNotNull("No existe la consignación", consignaciones);
		consignaciones.setConDescripcion("Consignación modificada");
